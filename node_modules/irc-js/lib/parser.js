...
if(typeof out=='string'){s=out;out=[];x=Parser(function(m,x,y){if(m=='fail')out=[false,x,y,s];if(m=='tree segment')out=out.concat(x)});x('chunk',s);x('eof');return out[0]===false?out:[true,{names:Parser.names,tree:out,input:s}]}
